...
<link href="${request.contextPath}/css/jquery-weui.min.css" rel="stylesheet">
<link rel="stylesheet" href="${request.contextPath}/css/mint.css">
<style type="text/css">
	 .carnum-input{
	 	text-align:center;
	 	height:30px;
...
<body style="background-color:#F2F2F2">
	 ...
	 <mt-tab-container-item >
		...
		<div align="center" style="padding-top:15px">
		    <div style="padding:5px;height:46px;padding-top:11px;padding-bottom:0px;border-radius:0px;background:white;">
				<form method="get" role="form" action="/pay/order" id="checkform">
					<input type="text" name="carnumber" value="" id = "carnumber" class="info">
                    ...
                    <input type="hidden" name="passid" value="${passid?c}" />
				</form>
			</div>
		</div>
		    	...
		    	<div style="display:inline;" v-for="letter3 in letters3">
					<mt-button :style="letter1Style" @click="handleClick(letter3.name)">
						<div v-if="letter3.name=='DEL'">
							<img src="${request.contextPath}/image/back.png" style="margin-top:4px" height="15" width="22" slot="icon">
						</div>
						<div v-if="letter3.name!='DEL'">
						{{letter3.name}}
						</div>
  ...
  <script src="${request.contextPath}/js/mint.js"></script>
